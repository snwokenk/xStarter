...
export const LAUNCHPAD_ADDRESS = {
  ...
  5: '0xEcA38A1866A802d1f4B1B2F1ba26a2565D57D2Eb',
...
\t\t\t}
\t\t],
\t\t"name": "checkSwapETHForTokensUsingDataFromBlockchain",
\t\t"outputs": [
\t\t\t{
\t\t\t\t"internalType": "address[]",
\t\t\t\t"name": "route",
...
\t\t\t}
\t\t],
\t\t"name": "checkSwapPercentOfApprovedBalance",
\t\t"outputs": [
\t\t\t{
\t\t\t\t"internalType": "address[]",
\t\t\t\t"name": "route",
...
export const SUPPORTED_FUNDING_TOKENS = {
  ...
  '0x0000000000000000000000000000000000000000-56': 'BNB'
  // add xstarter token
}
...
export const ARRAY_OF_BLOCKCHAINS = [
  {label: 'Ethereum Mainnet', value: 1},
  {label: 'Binance Smart Chain', value: 56},
  {label: 'Polygon (Matic)', value: 137},
  {label: 'Avalanche Network', value: 43114},
  {label: 'xDai', value: 100 },
  {label: 'Goerli Testnet (ETH)', value: 5},
  {label: 'Hardhat Localhost', value: 31337}
]

export const BLOCKCHAIN_TO_DEX = {
  // Ethereum Main Net
  1: [
    {
      label: 'UniSwapV2',
  ...
  56: [
    {
      ...
      // "0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c","0xe9e7cea3dedca5984780bafc599bd69add087d56","0x10ED43C718714eb63d5aA57B78B54704E256024E","0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73"
  ...
  43114: [
    {
      ...
      WETH: '0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7', // shown as WAVAX in code
      routerABI: traderJoeRouterV2ABI, // rather than AddLiquidityETH uses AddLiquidityAVAX
      factoryABI: traderJoeFactoryV2ABI
