...
import StoreDexTrades from "components/Blockchain/StoreDexTrades";
...
export default defineComponent( {
  ...
  setup() {
      ...
      return {getProvider, getLocalProvider,getPCakeRouter, getSigner, getLaunchPadContract, getConnectedAndPermissioned, connectedAccount, chainId, current: ref(1)}
    },
  data() {
      return {
        arrayOfTxs: [],
